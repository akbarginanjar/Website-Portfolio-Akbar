export const translations = {
  en: {
    ...
    "about.title": "About",
    "about.p1": "I'm Akbar Ginanjar, a student of Bachelor of Informatics Engineering (S1 Teknik Informatika) at STMIK Mardira Indonesia, and a developer focused on building modern web and mobile applications. I work across frontend, backend and mobile ecosystems, and spend increasing amounts of time exploring how AI can make digital products more intelligent.",
    ...
    "certificates.open": "Open credential",
  ...
  id: {
    ...
    "skill.title": "Keahlian",
    "certificates.title": "Sertifikat",
    "certificates.open": "Buka kredensial",
    "stack.title": "Teknologi",
    "work.title": "Karya Pilihan",
    "work.visit": "Kunjungi website",
    "work.close": "Tutup",
  ...
  su: {
    ...
    "about.p1": "Abdi Akbar Ginanjar, mahasiswa S1 Teknik Informatika di STMIK Mardira Indonesia, sarta panembang nu fokus kana ngawangun aplikasi web jeung mobile modern. Abdi digawé dina ekosistém frontend, backend, jeung mobile, sarta beuki loba waktos ngajajah kumaha AI tiasa ngajadikeun produk digital leuwih cerdas.",
